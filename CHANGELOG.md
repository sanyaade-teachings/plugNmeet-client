...
## [2.2.0](https://github.com/sanyaade-teachings/plugNmeet-client/compare/v2.1.9...v2.2.0) (2026-05-10)


### Features

* SIP dial-in ([816b37e](https://github.com/sanyaade-teachings/plugNmeet-client/commit/816b37ef0975b902048953c04aaf073bb972ba2a))


### Bug Fixes

* `pauseUpstream` when we're not connected with NATS ([669da1b](https://github.com/sanyaade-teachings/plugNmeet-client/commit/669da1bacf6deb9eafa63170fbeeedad695c427f))
* because of race-condition same track was publishing multiple times ([82fdcbc](https://github.com/sanyaade-teachings/plugNmeet-client/commit/82fdcbc62ebd12d5ddc4ac28b0309e7ce9326a67))
* better to use `onInitialize` to set `ExcalidrawImperativeAPI` ([e1635fa](https://github.com/sanyaade-teachings/plugNmeet-client/commit/e1635fa30ca04561af42ad87f543e00ed8d11b81))
* better to use `switch` ([fa2b468](https://github.com/sanyaade-teachings/plugNmeet-client/commit/fa2b4689acd0ed449d8e6707c21a3761cd354716))
* bug fix and improved LTI ([5df719c](https://github.com/sanyaade-teachings/plugNmeet-client/commit/5df719c4ea3bc086f83f05e361911f26bf9119a2))
* bump `vite` ([1ea0108](https://github.com/sanyaade-teachings/plugNmeet-client/commit/1ea01087b041553584b13c068604edf84aa70bed))
* bump actions ([88df64f](https://github.com/sanyaade-teachings/plugNmeet-client/commit/88df64fef59199358c6f0fdf49813a6f9312cd51))
* bump actions ([72236c3](https://github.com/sanyaade-teachings/plugNmeet-client/commit/72236c390cfb5b2361615c4ed2f9ecc3157672a0))
* bump deps ([5898563](https://github.com/sanyaade-teachings/plugNmeet-client/commit/589856357cbaecfac4daed0cbec16a790b926e1b))
* bump deps ([c33889a](https://github.com/sanyaade-teachings/plugNmeet-client/commit/c33889ab87b3198e4d79998af7103a353ac84cec))
* bump deps ([7cc974a](https://github.com/sanyaade-teachings/plugNmeet-client/commit/7cc974a95ee1acf208cf24c8c4b0ad0067bd7baa))
* bump deps ([16d1d94](https://github.com/sanyaade-teachings/plugNmeet-client/commit/16d1d9470928e97edbd618d698cd06dcc542d762))
* bump deps ([a7fff52](https://github.com/sanyaade-teachings/plugNmeet-client/commit/a7fff520761d3a1a931f0159fdbaec8cb51d1c66))
* bump deps ([96f2ecb](https://github.com/sanyaade-teachings/plugNmeet-client/commit/96f2ecbb5e5b7c148202ba48c695caff2a371e1b))
* bump deps ([ec36279](https://github.com/sanyaade-teachings/plugNmeet-client/commit/ec362790cfc2babb6e96279bf65ac0c9e9385e74))
* bump deps ([53de031](https://github.com/sanyaade-teachings/plugNmeet-client/commit/53de031de6948fad6d3264c1eb3fa5e1c494cc96))
* bump proto ([db13125](https://github.com/sanyaade-teachings/plugNmeet-client/commit/db1312546d45c452de35ebaedc1eaaabb4e9c163))
* bump proto ([e4f02e2](https://github.com/sanyaade-teachings/plugNmeet-client/commit/e4f02e2dd03fe676e9afc786fb50ae9850e2907d))
* check contrast ratio before applying custom design for better view ([ce4d806](https://github.com/sanyaade-teachings/plugNmeet-client/commit/ce4d80667d0be8cc3cc79cc27bd10a4cfcf3d0ab))
* clean up + bump proto ([0835005](https://github.com/sanyaade-teachings/plugNmeet-client/commit/0835005c2ce16b896bd59595e77e3bbc2828bce7))
* configurable option to `fallback_turn` when connection bad ([5870443](https://github.com/sanyaade-teachings/plugNmeet-client/commit/58704439489c3d3ff2728bbb11e8f4fd79f702f4))
* continue looping without waiting ([f68b596](https://github.com/sanyaade-teachings/plugNmeet-client/commit/f68b59669109e5d499062f75c04608fe5f920373))
* **critical:** duplicate event was sending because of using same subject for both JS and Core pub/sub ([4bf7815](https://github.com/sanyaade-teachings/plugNmeet-client/commit/4bf7815b1ded941835adde07bf9becf8a1935f62))
* deliver private messages routed by server through private channel ([3334261](https://github.com/sanyaade-teachings/plugNmeet-client/commit/3334261126763fc70368cd4986a15f5339bce8b9))
* deps update ([0540223](https://github.com/sanyaade-teachings/plugNmeet-client/commit/0540223928193294138c7994c7a8ff934b5ecc0a))
* deps upgrade ([5222420](https://github.com/sanyaade-teachings/plugNmeet-client/commit/5222420d24136cea40636ac1af78fdd417274d66))
* **deps:** update dependency axios to v1.13.3 ([8867b4c](https://github.com/sanyaade-teachings/plugNmeet-client/commit/8867b4c648f88776db2830918ba7719e95bdf56d))
* **deps:** update dependency axios to v1.13.3 ([a84c262](https://github.com/sanyaade-teachings/plugNmeet-client/commit/a84c26246fda247d39013aed2d60f00ac0f2c77f))
* disable `relay` for mobile firefox for the moment. ([76def67](https://github.com/sanyaade-teachings/plugNmeet-client/commit/76def67f03b594c9a29ef4416300f2f33451f302))
* don't process for firefox mobile for the moment ([3edf0bc](https://github.com/sanyaade-teachings/plugNmeet-client/commit/3edf0bcb3587759ff1f951749a2c996988032deb))
* Empty Video Stream was giving LK brandwidth algo false-positive result ([863bb96](https://github.com/sanyaade-teachings/plugNmeet-client/commit/863bb96998db253856a19570d27f4e3d15c3aa24))
* ensure DB connected before operation ([9a7024b](https://github.com/sanyaade-teachings/plugNmeet-client/commit/9a7024bde4ead9db14076eec516b09b08ce6d50d))
* ensure NATS is connected for using any service ([aca2c6f](https://github.com/sanyaade-teachings/plugNmeet-client/commit/aca2c6f9e91cb67f1dafa1e412cb93c4cb0e210c))
* **feat:** new option `fallback_on_flapping` for turn server ([79564f1](https://github.com/sanyaade-teachings/plugNmeet-client/commit/79564f10913a65427d11ccf148cd8f94190e31e5))
* **feat:** option to configure custom turn servers ([278923c](https://github.com/sanyaade-teachings/plugNmeet-client/commit/278923cdd1af0c55d969c2ac93eb75873aa35a7d))
* **feat:** option to configure custom turn servers ([034aeae](https://github.com/sanyaade-teachings/plugNmeet-client/commit/034aeae0de6b1a6769157241e9b37badaf2b7a19))
* **feature:** implemented PiP using upcoming `DocumentPictureInPicture` feature ([0bdaeec](https://github.com/sanyaade-teachings/plugNmeet-client/commit/0bdaeec9a12880ebc283f954b154f0fc1286ac90))
* **feature:** implemented PONG from server to client to detect backend server's responsiveness ([34b8101](https://github.com/sanyaade-teachings/plugNmeet-client/commit/34b81017d31258b2dca6f7f9276ef340e63ef46e))
* follow NATS ping interval same as application ([ca3500e](https://github.com/sanyaade-teachings/plugNmeet-client/commit/ca3500e7ccb62031849da7920504d58671ae5ba4))
* for VB use `webgl2` as default pipeline with fallback to `canvas2dCpu` ([3b4238c](https://github.com/sanyaade-teachings/plugNmeet-client/commit/3b4238c6c766000dd4099916a8661531584e4e11))
* header tab design ([e2d5e36](https://github.com/sanyaade-teachings/plugNmeet-client/commit/e2d5e36028bded7e214555667575b7c2ccd5368f))
* header tab size problem ([6d9358c](https://github.com/sanyaade-teachings/plugNmeet-client/commit/6d9358c1379694fa99e47fcfeb73e05fb28353d8))
* improve display VB + clear properly ([371e166](https://github.com/sanyaade-teachings/plugNmeet-client/commit/371e166ecd6a96b7dd7ffe90e44af747fe7b3976))
* invalid avatar for SIP phone ([438d1d3](https://github.com/sanyaade-teachings/plugNmeet-client/commit/438d1d30f315286509ca4c34a7bab71f4ece386f))
* load models during bootup and cache for loading faster next time ([d734345](https://github.com/sanyaade-teachings/plugNmeet-client/commit/d734345994be74815727d06cd6c04dbaf22925ef))
* **LTI:** logic + style ([6b9bb62](https://github.com/sanyaade-teachings/plugNmeet-client/commit/6b9bb62e554b0bab0e3a2b5e323c539d780c0a92))
* mask phone number in proper way ([41f4123](https://github.com/sanyaade-teachings/plugNmeet-client/commit/41f412350226765b665a1ae1ab0052f5a75a40b8))
* merged notification into application ([0d81614](https://github.com/sanyaade-teachings/plugNmeet-client/commit/0d81614768414649277aa1ad9e579216a400e935))
* migrate chat to core pub/sub ([307c735](https://github.com/sanyaade-teachings/plugNmeet-client/commit/307c735977b82de910f3e960108dcd36123c7604))
* missed to update token :( ([225af75](https://github.com/sanyaade-teachings/plugNmeet-client/commit/225af75ecc9ccba4c046c018e0d02591950d96f7))
* nats connection tag name ([38aec54](https://github.com/sanyaade-teachings/plugNmeet-client/commit/38aec54320b9757347558ca1a1a21d701a50868c))
* nats optimisation ([2141234](https://github.com/sanyaade-teachings/plugNmeet-client/commit/2141234e0e61cf69388e396253462f31bbdbb2f8))
* nats optimisation ([4547a08](https://github.com/sanyaade-teachings/plugNmeet-client/commit/4547a0882848f60b31a02fde934341e3b9dd3668))
* **nats:** Implemented new system pub/sub core channel and moved `sendAnalyticsData` to use it. ([f583fc8](https://github.com/sanyaade-teachings/plugNmeet-client/commit/f583fc8653f58e1c95a8a3b2eebad29de2b98216))
* new Crowdin updates ([44c2953](https://github.com/sanyaade-teachings/plugNmeet-client/commit/44c2953c0419a1956df1ae82b243e63c5ca3828c))
* new Crowdin updates ([3b84db6](https://github.com/sanyaade-teachings/plugNmeet-client/commit/3b84db6d65f5cd059357ae653a29658805ed8fc9))
* new Crowdin updates ([35dfe66](https://github.com/sanyaade-teachings/plugNmeet-client/commit/35dfe6656a7d605eb20f2adaf0f35c377473d924))
* new Crowdin updates ([cf973d0](https://github.com/sanyaade-teachings/plugNmeet-client/commit/cf973d03d838e21567e007b10856fc417adab3d4))
* new Crowdin updates ([fc6ed1a](https://github.com/sanyaade-teachings/plugNmeet-client/commit/fc6ed1aed227bce45cd67ab0d776c51a7bee20e9))
* new Crowdin updates ([c514b25](https://github.com/sanyaade-teachings/plugNmeet-client/commit/c514b2514762c6728426de6fd11f68d8e4e93e42))
* new Crowdin updates ([692e047](https://github.com/sanyaade-teachings/plugNmeet-client/commit/692e047cbda235375951dda25c340a0cafd215f6))
* option to configure `enableAdaptiveStream` ([6b71b25](https://github.com/sanyaade-teachings/plugNmeet-client/commit/6b71b2546160a7d87a9250739bcd326624c9ca5c))
* option to set `fallbackTimerDuration` in server config ([81fb2f1](https://github.com/sanyaade-teachings/plugNmeet-client/commit/81fb2f1309a7e1038f5d7ea78dc263dee22ae093))
* original message was translated for owner as well ([9839a88](https://github.com/sanyaade-teachings/plugNmeet-client/commit/9839a88326a59279a630e6abe48bfbc7a000cf3b))
* periodically sync users and reconcile ([8fb8bc0](https://github.com/sanyaade-teachings/plugNmeet-client/commit/8fb8bc0390cc18966060826ad569eb01d1f0f5b4))
* prevent duplicate click while sharing screen task in progress ([6de8fac](https://github.com/sanyaade-teachings/plugNmeet-client/commit/6de8faccb6a71e2323d03d0c3e9f345f376d3e8a))
* prevent echo back to sender ([0323d34](https://github.com/sanyaade-teachings/plugNmeet-client/commit/0323d34df5f0487310ab1909c976aa9262fa6c36))
* problem with crossOrigin ([7b4fb62](https://github.com/sanyaade-teachings/plugNmeet-client/commit/7b4fb62132a2da1c4ed0ab88708c2922311d4ac5))
* recorder chat was not auto scrolling ([260fcee](https://github.com/sanyaade-teachings/plugNmeet-client/commit/260fcee950838f36983e37d575a7449408b5d530))
* **refactor:** virtual background replaced with `@twilio/video-processors` library ([096b9e6](https://github.com/sanyaade-teachings/plugNmeet-client/commit/096b9e65115b7749e1339155c7694ce909c6d470))
* **refactor:** virtual background replaced with `@twilio/video-processors` library ([7b7d125](https://github.com/sanyaade-teachings/plugNmeet-client/commit/7b7d125272598abfaf4ed13cf6f1348c8adb0284))
* remove `replaceTrack` track as it's creating problem with bandwidth algo ([6a00290](https://github.com/sanyaade-teachings/plugNmeet-client/commit/6a002900af9d04d32a5eb713d41fb2758154beae))
* removed contrast checker and let user check and apply according to their need ([d5173d8](https://github.com/sanyaade-teachings/plugNmeet-client/commit/d5173d8872d771185140eb8846900c6fd9da2259))
* removed deprecated option ([f3daa44](https://github.com/sanyaade-teachings/plugNmeet-client/commit/f3daa44a8a1c5c0cde83bb0d856d355a7fdecbda))
* reverted back ([998a8aa](https://github.com/sanyaade-teachings/plugNmeet-client/commit/998a8aa321b3967db52c177ee27115f8568d9c2b))
* **screenshare:** Handle share cancellation and add error notification, fixed: [#1030](https://github.com/sanyaade-teachings/plugNmeet-client/issues/1030) ([1085b4d](https://github.com/sanyaade-teachings/plugNmeet-client/commit/1085b4de08ce8e174505f1a6d3edc6da0215fffc))
* Separate NATS & LK subscription logic into handler ([a63fbb1](https://github.com/sanyaade-teachings/plugNmeet-client/commit/a63fbb1f8079b6e82eb107787036a9e9e85c4aa2))
* Separate NATS & LK subscription logic into handler ([57d8aaa](https://github.com/sanyaade-teachings/plugNmeet-client/commit/57d8aaa78c642fd1fccf2aee9061e9560bab379c))
* SIP design + logic ([b13b5b1](https://github.com/sanyaade-teachings/plugNmeet-client/commit/b13b5b14e767f7b0879385ef349d9db936e8d4e8))
* SIP user name ([5d44a47](https://github.com/sanyaade-teachings/plugNmeet-client/commit/5d44a47c038e695967833835b1637a99449c2a58))
* spacing issue ([ea46de3](https://github.com/sanyaade-teachings/plugNmeet-client/commit/ea46de386824226a6ce6879006912c15058ef1a3))
* spacing issue ([8cf54f2](https://github.com/sanyaade-teachings/plugNmeet-client/commit/8cf54f29ef9b9fd5b9888e55db75da4ed8783060))
* toast wasn't cleaning ([18ed195](https://github.com/sanyaade-teachings/plugNmeet-client/commit/18ed195c46935868d49a433226fb742dff7d44cf))
* trying to send message when nats disconnected ([779a77f](https://github.com/sanyaade-teachings/plugNmeet-client/commit/779a77f5899a0401abb2fcb97a192eb7d0e39ed2))
* update language strings ([9ae14d8](https://github.com/sanyaade-teachings/plugNmeet-client/commit/9ae14d85927d3fadf5dbaa09e2754400973b3c17))
* update language strings ([ada3cba](https://github.com/sanyaade-teachings/plugNmeet-client/commit/ada3cba5aaec2f31dffdca58819a01981d1fc976))
* update the data flow ([55f78f8](https://github.com/sanyaade-teachings/plugNmeet-client/commit/55f78f8a0251f3a3767c41ac7eb53e385f669f1c))
* upgrade excalidraw to latest RC ([ea96d99](https://github.com/sanyaade-teachings/plugNmeet-client/commit/ea96d9939105e38a4ab4b56c027ccfc89ba569fd))
* use `CorsWorker` from `[@twilio](https://github.com/twilio)` ([e5ba2ea](https://github.com/sanyaade-teachings/plugNmeet-client/commit/e5ba2eabbb4d68d1605cbaa5fcf3dd253f3d84c3))
* use Map for O(1) lookups ([e8beebf](https://github.com/sanyaade-teachings/plugNmeet-client/commit/e8beebf73228dfe64b9659ddcf8013f33c02f2e9))
* use nats core pub/sub for high-performance, loss-tolerant events like `TRANSCRIPTION_OUTPUT_TEXT` ([74b1f17](https://github.com/sanyaade-teachings/plugNmeet-client/commit/74b1f178fce4d611ad2e039190fcf133f012bc91))
* use recommended resolution ([5003c52](https://github.com/sanyaade-teachings/plugNmeet-client/commit/5003c52ff2f9c1099da933794fd57721a9a12ffa))
* use sip provided name ([fe705fa](https://github.com/sanyaade-teachings/plugNmeet-client/commit/fe705fa2c6abd6638d3d9a172bf79daea8e3c805))
* use timer to execute fallback ([d6857db](https://github.com/sanyaade-teachings/plugNmeet-client/commit/d6857db46f680ec1ff7bfffde62c46fb7421f945))
* use value from declared + deps update ([2aacf4e](https://github.com/sanyaade-teachings/plugNmeet-client/commit/2aacf4ee3a94b6548ad4a5d3b8fcb22c39d7d405))
* video participant race condition upon ws disconnection ([1eccebf](https://github.com/sanyaade-teachings/plugNmeet-client/commit/1eccebf71e419dd7be19be27fb0c2222d67fb92e))
* video participant race condition upon ws disconnection ([439f8af](https://github.com/sanyaade-teachings/plugNmeet-client/commit/439f8af1882fd782f786d0035e2ad7263a2ce076))
* webcam toggle was loosing virtual background ([882b561](https://github.com/sanyaade-teachings/plugNmeet-client/commit/882b561154cbc8b0b4ba1ab45c6a707d4c4094f7))
* whiteboard style ([fc09589](https://github.com/sanyaade-teachings/plugNmeet-client/commit/fc09589dc394a0d173a008df6b0d1fd104274528))
* whiteboard style ([2c3843a](https://github.com/sanyaade-teachings/plugNmeet-client/commit/2c3843a6484cb2219189f9818745a01e0ab1e470))
* with new option `stripBase` ([6e8151d](https://github.com/sanyaade-teachings/plugNmeet-client/commit/6e8151d2bab764234a3a7d0c53a3c6e5bed03cf8))
* wrong filtering of data ([5a1d213](https://github.com/sanyaade-teachings/plugNmeet-client/commit/5a1d213877af40cc170ccfd359d5a334ab25c07e))
